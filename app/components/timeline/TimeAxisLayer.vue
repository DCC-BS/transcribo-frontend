...
const timeTicks = computed(() => {
    ...
    const firstTick =
        Math.ceil(props.startTime / tickIntervalSeconds) * tickIntervalSeconds;
...
function fromTimetoPixelSpace(time: number): number {
    ...
    const timePercentage =
        (time - props.startTime) / (props.endTime - props.startTime);
