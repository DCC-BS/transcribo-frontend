...
type _CoercedEnvSchema_787c172c = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_787c172c> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_787c172c, 'APP_MODE' | 'USE_FEEDBACK' | 'IS_RUNTIME' | 'IS_BUILDTIME'>> {}
}
...
type _EnvSchemaAsStrings_787c172c = EnvSchemaAsStrings;
declare global {

  // add types for global import.meta.env
  interface ImportMetaEnv extends _EnvSchemaAsStrings_787c172c {}
  ...
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_787c172c {}
  }
}