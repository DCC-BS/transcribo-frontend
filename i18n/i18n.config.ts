    ...
    messages: {
        en: {
            upload: {
                ...
                processingError:
                    "Failed to process the media file. Please try again.",
            },
            pages: {
                index: {
                    ...
                    experimental:
                        "The recording feature is experimental and only tested with short recordings. It may not work for long recordings.",
                },
            },
            navigation: {
                new: "New",
            ...
            ui: {
                saveChangesHint:
                    "Leave text field or press Enter to save changes",
                emptyState: {
                    title: "No data found",
            ...
            commands: {
                empty: "Empty Command",
                startTranscription:
                    "Start Transcription: Task ID {taskId}, File: {fileName}",
                transcriptionFinished:
                    "Transcription Finished: Status {status}{hasResults}",
            ...
            help: {
                ...
                mediaControls: {
                    ...
                    spectrogramClick:
                        "Click or drag on the {spectrogram} to seek to a specific position",
                    arrowKeys:
                        "Use {leftKey} or {rightKey} to seek 5 seconds back or forward",
                    shiftArrows:
                        "Hold {shiftKey} + {leftKey}/{rightKey} to seek 30 seconds",
                    ctrlArrows:
                        "Hold {ctrlKey} + {leftKey}/{rightKey} to seek 1 second",
                    mouseWheel:
                        "Use mouse wheel to zoom into the {timeline}, or use the range slider below",
                    ctrlClick:
                        "Use {ctrlKey} + left click to move around the {timeline}",
                },
                segments: {
                    ...
                    speaker:
                        "In the {dropdown}, assign a speaker (type in the search box to create a new speaker)",
                    timeChange:
                        "Change the time in seconds in the {timespanTextFields}",
                    seekTime: "Click on the timestamps to seek to that time",
                    insertBefore:
                        "Press the button with the arrow up {insertAbove} to insert a segment before",
                    insertAfter:
                        "Press the button with the arrow down {insertBelow} to insert a segment below",
                    deleteSegment:
                        "Press the delete button {delete} to remove the segment",
                },
                timeline: {
                    title: "Working with Segments on Timeline",
                    hoverText: "Hover over a rectangle to see the text",
                    clickSelect:
                        "Click on a rectangle to select it and see the handles",
                    moveWithKeys:
                        "When selected, you can move the rectangle 0.5 seconds to the left or right with the arrow keys",
                    dragMove: "Drag the rectangle to move it",
                    resizeHandles:
                        "Drag the handles on the left or right side to resize the rectangle",
                    altSnap:
                        "Hold the {altKey} key while moving to prevent snapping to other rectangles",
                },
                editing: {
        ...
        de: {
            upload: {
                ...
                processingError:
                    "Fehler bei der Verarbeitung der Mediendatei. Bitte versuchen Sie es erneut.",
            },
            pages: {
                index: {
            ...
            transcription: {
                ...
                loading: "Lädt...",
                notFound:
                    "Transkription nicht gefunden oder konnte nicht geladen werden",
                noTranscriptionsFound: "Keine Transkriptionen gefunden",
                untitled: "Ohne Titel",
                delete: {
                    title: "Transkription löschen",
                    confirmation:
                        "Sind Sie sicher, dass Sie diese Transkription löschen möchten?",
                },
                actions: {
                    edit: "Bearbeiten",
                    delete: "Löschen",
            ...
            ui: {
                saveChangesHint:
                    "Textfeld verlassen oder Enter drücken, um Änderungen zu übernehmen",
                emptyState: {
            ...
            commands: {
                empty: "Leerer Befehl",
                startTranscription:
                    "Starte Transkription: Aufgaben-ID {taskId}, Datei: {fileName}",
                transcriptionFinished:
                    "Transkription abgeschlossen: Status {status}{hasResults}",
                ...
                updateSegmentNoUpdates:
                    "Segment aktualisieren: Keine Änderungen",
            ...
            help: {
                ...
                mediaControls: {
                    ...
                    spacebar:
                        "Drücken Sie {space} zum Abspielen/Pausieren von Video oder Audio",
                    spectrogramClick:
                        "Klicken oder ziehen Sie auf das {spectrogram}, um zu einer bestimmten Position zu springen",
                    arrowKeys:
                        "Verwenden Sie {leftKey} oder {rightKey} um 5 Sekunden zurück oder vorwärts zu springen",
                    shiftArrows:
                        "Halten Sie {shiftKey} + {leftKey} / {rightKey} um 30 Sekunden zu springen",
                    ctrlArrows:
                        "Halten Sie {ctrlKey} + {leftKey} / {rightKey} um 1 Sekunde zu springen",
                    mouseWheel:
                        "Verwenden Sie das Mausrad zum Zoomen in die {timeline} oder nutzen Sie den Bereichsregler unten",
                    ctrlClick:
                        "Verwenden Sie {ctrlKey} + Linksklick, um sich auf der {timeline} zu bewegen",
                },
                segments: {
                    ...
                    speaker:
                        "Im {dropdown} können Sie einen Sprecher zuweisen (tippen Sie in das Suchfeld, um einen neuen Sprecher zu erstellen)",
                    timeChange:
                        "Ändern Sie die Zeit in Sekunden in den {timespanTextFields}",
                    seekTime:
                        "Klicken Sie auf die Zeitstempel, um zu dieser Zeit zu springen",
                    insertBefore:
                        "Drücken Sie den Knopf mit dem Pfeil {insertAbove} nach oben, um ein Segment davor einzufügen",
                    insertAfter:
                        "Drücken Sie den Knopf mit dem Pfeil {insertBelow} nach unten, um ein Segment danach einzufügen",
                    deleteSegment:
                        "Drücken Sie den Löschen-Knopf {delete}, um das Segment zu entfernen",
                },
                timeline: {
                    title: "Arbeiten mit Segmenten auf der Zeitleiste",
                    hoverText:
                        "Fahren Sie mit dem Mauszeiger über ein Rechteck, um den Text zu sehen",
                    clickSelect:
                        "Klicken Sie auf ein Rechteck, um es auszuwählen und die Griffe zu sehen",
                    moveWithKeys:
                        "Wenn ausgewählt, können Sie das Rechteck mit den Pfeiltasten um 0,5 Sekunden nach links oder rechts verschieben",
                    dragMove: "Ziehen Sie das Rechteck, um es zu verschieben",
                    resizeHandles:
                        "Ziehen Sie die Griffe auf der linken oder rechten Seite, um das Rechteck in der Größe zu ändern",
                    altSnap:
                        "Halten Sie die {altKey}-Taste gedrückt, während Sie es verschieben, um das Einrasten an anderen Rechtecken zu verhindern",
                },
                editing: {
                    ...
                    buttons:
                        "Oder drücken Sie die Schaltflächen für Rückgängig/Wiederholen oben links",
                },
            },
        },
    },
