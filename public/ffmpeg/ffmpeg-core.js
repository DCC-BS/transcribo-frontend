    ...
    return (createFFmpegCore = {}) => {
        ...
        var SOCKFS = {
            ...
            websocket_sock_ops: {
                createPeer: (sock, addr, port) => {
                    ...
                    if (ws) {
                        if (ws._socket) {
                            ...
                            addr = result[1];
                            port = Number.parseInt(result[2], 10);
                        }
                    } else {
                        try {
                            var runtimeConfig =
                ...
                getPeer: (sock, addr, port) => sock.peers[addr + ":" + port],
                addPeer: (sock, peer) => {
        ...
        function __emscripten_throw_longjmp() {
            throw Number.POSITIVE_INFINITY;
        }
        ...
        var ___wasm_call_ctors = () =>
            (___wasm_call_ctors = Module["asm"]["sa"]).apply(null, arguments);
        var _malloc = (Module["_malloc"] = () =>
            (_malloc = Module["_malloc"] = Module["asm"]["ta"]).apply(
                null,
                arguments,
            ));
        var ___errno_location = () =>
            (___errno_location = Module["asm"]["va"]).apply(null, arguments);
        var _ntohs = () =>
            (_ntohs = Module["asm"]["wa"]).apply(null, arguments);
        var _htons = () =>
            (_htons = Module["asm"]["xa"]).apply(null, arguments);
        var _ffmpeg = (Module["_ffmpeg"] = () =>
            (_ffmpeg = Module["_ffmpeg"] = Module["asm"]["ya"]).apply(
                null,
                arguments,
            ));
        var _ffprobe = (Module["_ffprobe"] = () =>
            (_ffprobe = Module["_ffprobe"] = Module["asm"]["za"]).apply(
                null,
                arguments,
            ));
        var _htonl = () =>
            (_htonl = Module["asm"]["Aa"]).apply(null, arguments);
        var _emscripten_builtin_memalign = () =>
            (_emscripten_builtin_memalign = Module["asm"]["Ba"]).apply(
                null,
                arguments,
            );
        var _setThrew = () =>
            (_setThrew = Module["asm"]["Ca"]).apply(null, arguments);
        var stackSave = () =>
            (stackSave = Module["asm"]["Da"]).apply(null, arguments);
        var stackRestore = () =>
            (stackRestore = Module["asm"]["Ea"]).apply(null, arguments);
        var ___cxa_is_pointer_type = () =>
            (___cxa_is_pointer_type = Module["asm"]["Fa"]).apply(
                null,
                arguments,
            );
